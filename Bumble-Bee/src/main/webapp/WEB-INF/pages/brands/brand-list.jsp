      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Brands List</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Active Brands</h6>
        </nav>
        
      <form id="formS" role="form" action="search-brand" method="Get">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="save-brand" method="POST">
    	...
    	<label for="exampleInputPassword1">Add new Brand</label>
    		<input type="text" class="form-control" id="exampleInputPassword1" placeholder="new Category" name="name">
  		</div>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                     <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Brand code</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Brand Name</th>
                       <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Brand status</th>
                    ...
                    <tr>
                     ...
                     <td>
                      ...
                      <td class="align-middle">
                        <a href="#" data-target="#exampleModal1" onclick="updateDiv('${brand.id}','${brand.name}')" data-toggle="modal" id="${brand.id}" class="text-info font-weight-bold text-xs myLink">
                       Edit</a>
                      ...
                      <td class="align-middle">
                        <a href="<%=request.getContextPath()%>/delete-brand?type=del&id=${brand.id}" class="text-danger font-weight-bold text-xs" data-toggle="tooltip"  data-original-title="delete user">
                        Delete 
                        </a> 
                      </td>
