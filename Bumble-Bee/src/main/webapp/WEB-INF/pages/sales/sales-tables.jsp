      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">sales List</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Active Products</h6>
        </nav>
        
      <form id="formS" role="form" action="search-sales" method="Get">
        <div class="collapse navbar-collapse mt-sm-1 mt-3 me-md-15 me-sm-6" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
               <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
                <input id="SInput" type="text" class="form-control" placeholder="user name" aria-label="User Name"  name="name">
            </div>
          	</div>
        </div>
      </form>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                     <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">ProductName</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">User</th>
                       <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">loanBalance</th>
                  ...
                  <tag:forEach var="uhp" items="${uhp}">
                    <tr>
                    
                     <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">${uhp.productName}</h6>
                          </div>
                        </div> 
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">${uhp.user}</h6>
                          </div>
                        </div> 
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">${uhp.loanBalance}</h6>
                          </div>
                        </div> 
                      </td>
                      

						<tag:if test="${uhp.status eq '0'}">
